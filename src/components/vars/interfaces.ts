 ...
 * @property {number=} packetSize - determine which amount of data is going to be loaded, default is 30, minimum 1 and
 * maximum 1000.
 * @property {number=} loadSize - determine maximum amount of data to keep into DOM, default is 120, minimum 1 and
 * maximum 10000.
 * @property {boolean=true} inRushLoad - allow initial load to be more large
 * @property {number=} inRushLoadSize - set a custom size for the inRushLoad
