    ...
    async (resolve, reject) => {
        ...
        if (initialProps != null) {
            if (initialProps.constructor !== Object) {
                ...
                for (const key of Object.keys(other)) {
                    console.warn(`Unrecognized prop ${key} in initialProps for EndlessScrollHandler component. ` +
        ...
        if (loadThreshold != null) {
            if (loadThreshold.constructor !== Object) {
                ...
                for (const key of Object.keys(other)) {
                    console.warn(`Unrecognized prop ${key} in loadThreshold for EndlessScrollHandler component. ` +
                        'This key will be ignored.')
                }
